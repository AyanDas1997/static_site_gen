...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_double_node_split(self):
        node = TextNode("This is text with a `code block` word", TextType.TEXT)
        node2 = TextNode("This is another text with a `different code block` word", TextType.TEXT)
        ...
        self.assertEqual(
            ...
            [
                ...
                TextNode("different code block", TextType.CODE),
                TextNode(" word", TextType.TEXT),
            ]
        )
    ...
    def test_split_link(self):
        node = TextNode(
            "This is text with an [google](https://www.google.com) and another [youtube](https://www.youtube.com)",
            TextType.TEXT,
        )
